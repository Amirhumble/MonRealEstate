          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4 md:w-fit">
            {projectStatuses.map((status) => (
              <button
                ...
                className={`rounded-2xl sm:rounded-3xl px-3 sm:px-5 py-2 sm:py-3 text-xs sm:text-sm font-semibold transition relative whitespace-nowrap ${
              ...
              >
                ...
                <span className="block sm:inline sm:ml-2 text-xs opacity-75">({getStatusCount(status)})</span>
              </button>
            ))}
          </div>
        </div>
