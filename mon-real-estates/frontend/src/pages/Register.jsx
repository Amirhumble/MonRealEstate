  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f4f4f4] p-4">
      <div className="w-full max-w-md rounded-3xl bg-white p-8 shadow-xl">
        <h1 className="text-3xl font-bold mb-6 text-center text-[#2c2863]">Create Your Account</h1>
        ...
        <p className="mt-5 text-center text-sm text-gray-600">
          ...
          <Link to="/login" className="font-semibold text-[#e81d2b] hover:text-[#c01622]">
            Sign in
          </Link>
        </p>
      </div>
